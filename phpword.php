...
<div class="notice"><img src="images/error.png" width="64" height="64" align="absmiddle" />Incorrect security code entered</div>
</div>';
exit();
}
//Captcha Check End
...
echo '<div class="success">
      <div class="notice"><img src="images/success.png" width="64" height="64" align="absmiddle" /><strong>Success!</strong> Certificate Data Found</div>
    </div>
...
echo '   <div class="success">
      <div class="notice"><img src="images/error.png" width="64" height="64" align="absmiddle" /><strong>Sorry</strong> We couldn\'t find that Certificate</div>
    </div>
